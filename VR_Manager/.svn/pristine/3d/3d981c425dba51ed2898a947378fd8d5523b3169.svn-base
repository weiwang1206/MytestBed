...
<div id="my_container">
	...
	<div id="right">
		<form action="saveUserInfoActoin" method="get">
  			<p>姓名：<input type="text" name="name" value="<s:property value='user.name'/>"/></p>
			<p>邮箱：<input type="text" name="email" value="<s:property value='user.email'/>"/></p>
			<p>手机号码：<input type="text" name="telephone" value="<s:property value='user.telephone'/>"/></p>
			<p>省份/州：<input type="text" name="province" value="<s:property value='user.province'/>"/></p>
			<p>城市：<input type="text" name="city" value="<s:property value='user.city'/>"/></p>
